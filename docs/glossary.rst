...
.. glossary::
   ...
   damage type: shock
      | Crackling electrical damage wielded by the most dangerous forces of nature, or particular mages. 
      | Shock damage dealt counts as environmental by default.
   damage type: true
   ...
   favor
     | The associated roll has its succeeding threshold altered by a corresponding amount. 1 favor will drop the threshold from 5+ to 4+, and -1 favor will narrow success to a flat 6.
     | Negative favor cannot go above 6.
   reroll
