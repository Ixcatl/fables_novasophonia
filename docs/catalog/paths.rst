...
.. tab-set::
  ...
  .. tab-item:: Summary
    ...
    *Prefix: "Fey"*
    ...
    Reveries are practitioners of charming magic. They put on a show for friend and foe in equal measure, drawing power from shock and awe to fuel their passions.
  ...
  .. tab-item:: Rank 1
    ...
    | **Inspired Spells**
    | When you cast any spell, you may spend 1 Dream to add +1 bonus die to the spell's attack roll or opposed check. A spell cannot be enhanced more than once.

  .. tab-item:: Rank 2

    | **Charisma Vacuum**
    | At the cost of 1 Anima, you can attempt an opposed Insight check against a target within Close range. If successful, you link with the target and leech energy from them. Immediately and at the end of each of the target's turns, it loses 1 Anima and you gain 1 Anima. The link breaks if you take external damage or attempt to make a new link, or if you or the target reach 0 Anima.
